...
class CharacterController {
    ...
    _LoadModels () {
        ...
        loader.load('./resources/characters/aj.fbx', (fbx) => {
            ...
            loader.load('walk_back.fbx', (a) => { _OnLoad('walk_back', a)})
            loader.load('jog.fbx', (a) => { _OnLoad('run', a)})
...
class WalkBackState extends State {
    ...
    Enter(prevState){
        const walkAction = this._parent._proxy._animations['walk_back'].action
        if(prevState){
            const prevAction = this._parent._proxy._animations[prevState.Name].action
    ...
    Enter(prevState) {
        ...
        if(prevState){
            ...
            if(prevState.Name == 'walk'){
                const ratio = prevAction.getClip().duration / prevAction.getClip().duration
